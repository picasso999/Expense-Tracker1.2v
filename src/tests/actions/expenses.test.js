...
test('should setup add expense action object with provided values', () => {
  // const expenseData = {   description: 'Rent',   amount: 109500,   createdAt:
  // 1000,
...
// const action = addExpense();   expect(action).toEqual({     type:
// 'ADD_EXPENSE',     expense: {       id: expect.any(String),
// description: '',
//       note: '',       amount: 0,       createdAt: 0     }   }); });